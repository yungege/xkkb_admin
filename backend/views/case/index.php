                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-csrf="<?= Yii::$app->request->csrfToken ?>">
                            <a class="btn btn-info btn-xs" href="http://www.xkkb.com.cn/zh_cn/case/<?= $row['id'] ?>?ca_f=<?= $row['category'] ?>" title="预览" aria-label="预览" data-pjax="0" target="__blank" style="margin-bottom: 5px;">
